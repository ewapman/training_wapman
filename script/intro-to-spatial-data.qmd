...
```{r}
# Will still be a spatial data frame but since one is not spatial you can use the regular join (joining by name of column versus linking geometries)
...
```{r}
#take out untion to combine the polygons
...
ggplot(pop_region_3338) +
  geom_sf(aes(fill = total_pop)) + #fill each polygon based on this
